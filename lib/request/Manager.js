 ...
 * @param object data              For POST  method, these  are the POST  data.
 *                                 For  all other  methods,  these are  the url
 *                                 parameters from the query string.
 *                                 Note: Mixed POST data and query string isn't
 *                                 supported by purpose.  Helps keeping a sound
 *                                 design.
