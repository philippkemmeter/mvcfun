...
module.exports = function(req, rawBody) {
    ...
    /**
     * Contains the request fragment (the part in the uri behind the #).
     *
     * @var {String}
     * @protected
     */
    ...
    if (req.url) {
        ...
        this._fragment = tmp.hash ? tmp.hash.substr(1) : '';
    }
...
/**
 * The fragment of the request uri (the part behind the #).
 *
 * @member {Object} fragment
 * @readonly
 */
nepp.createGS(module.exports.prototype, 'fragment',
