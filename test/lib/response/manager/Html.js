...
describe('response.manager.Html', function() {
    describe('#constructor', function() {
        it('should have defaults as documented', function() {
            var resp_man = new mvcfun.response.manager.Html();
            resp_man.charset.should.equal('utf-8');
            resp_man.contentType.should.equal('text/html');
        });
    });
    //
    // Tests reponse.manager.Html.write
    //
    ...
    describe('#writeInternalServerError', function() {
        it(
            'should write status 500 as text/html',
            function(done) {
                var ServerResp = function() {};
                util.inherits(ServerResp, http.ServerResponse);
                ServerResp.prototype.end = function(content) {
    ...
    describe('#writeForbidden', function() {
        it(
            'should write status 403 as text/html',
            function(done) {
    ...
    describe('#writeNotFound', function() {
        it(
            'should write status 404 as text/html',
            function(done) {
    ...
    describe('#writeUnauthorized', function(){
        it(
            'should write status 401 as text/html',
            function(done) {
    ...
    describe('#writeMethodNotAllowed', function(){
        it(
            'should write status 405 as text/html',
            function(done) {
